...
_OUTPUT = _descriptor.Descriptor(
  name='Output',
  full_name='models.Output',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='amount', full_name='models.Output.amount', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='script', full_name='models.Output.script', index=1,
...
_PAYMENTDETAILS = _descriptor.Descriptor(
  name='PaymentDetails',
  full_name='models.PaymentDetails',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='network', full_name='models.PaymentDetails.network', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outputs', full_name='models.PaymentDetails.outputs', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time', full_name='models.PaymentDetails.time', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expires', full_name='models.PaymentDetails.expires', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memo', full_name='models.PaymentDetails.memo', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='payment_url', full_name='models.PaymentDetails.payment_url', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='merchant_data', full_name='models.PaymentDetails.merchant_data', index=6,
...
_PAYMENTREQUEST = _descriptor.Descriptor(
  name='PaymentRequest',
  full_name='models.PaymentRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='payment_details_version', full_name='models.PaymentRequest.payment_details_version', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pki_type', full_name='models.PaymentRequest.pki_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pki_data', full_name='models.PaymentRequest.pki_data', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='serialized_payment_details', full_name='models.PaymentRequest.serialized_payment_details', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='signature', full_name='models.PaymentRequest.signature', index=4,
...
_X509CERTIFICATES = _descriptor.Descriptor(
  ...
  full_name='models.X509Certificates',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='certificate', full_name='models.X509Certificates.certificate', index=0,
...
_PAYMENT = _descriptor.Descriptor(
  name='Payment',
  full_name='models.Payment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='merchant_data', full_name='models.Payment.merchant_data', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transactions', full_name='models.Payment.transactions', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='refund_to', full_name='models.Payment.refund_to', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memo', full_name='models.Payment.memo', index=3,
...
_PAYMENTACK = _descriptor.Descriptor(
  name='PaymentACK',
  full_name='models.PaymentACK',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='payment', full_name='models.PaymentACK.payment', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memo', full_name='models.PaymentACK.memo', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Output = _reflection.GeneratedProtocolMessageType('Output', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:models.Output)
  ))
...
PaymentDetails = _reflection.GeneratedProtocolMessageType('PaymentDetails', (_message.Message,), dict(
  ...
  __module__ = 'paymentrequest_pb2'
  # @@protoc_insertion_point(class_scope:models.PaymentDetails)
  ))
...
PaymentRequest = _reflection.GeneratedProtocolMessageType('PaymentRequest', (_message.Message,), dict(
  ...
  __module__ = 'paymentrequest_pb2'
  # @@protoc_insertion_point(class_scope:models.PaymentRequest)
  ))
...
X509Certificates = _reflection.GeneratedProtocolMessageType('X509Certificates', (_message.Message,), dict(
  ...
  __module__ = 'paymentrequest_pb2'
  # @@protoc_insertion_point(class_scope:models.X509Certificates)
  ))
...
Payment = _reflection.GeneratedProtocolMessageType('Payment', (_message.Message,), dict(
  DESCRIPTOR = _PAYMENT,
  __module__ = 'paymentrequest_pb2'
  # @@protoc_insertion_point(class_scope:models.Payment)
  ))
...
PaymentACK = _reflection.GeneratedProtocolMessageType('PaymentACK', (_message.Message,), dict(
  ...
  __module__ = 'paymentrequest_pb2'
  # @@protoc_insertion_point(class_scope:models.PaymentACK)
  ))
